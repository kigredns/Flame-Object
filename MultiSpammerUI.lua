...
function a:Window(w)
    ...
    y.Name = "Top"
    y.Parent = t
    y.BackgroundColor3 = Color3.fromRGB(2, 2, 2)
    y.BorderSizePixel = 0
    ...
    A.Color =
        ...
        ColorSequenceKeypoint.new(0.50, Color3.fromRGB(143, 255, 0)),
        ColorSequenceKeypoint.new(0.80, Color3.fromRGB(2, 2, 2)),
    ...
    B.TextColor3 = Color3.fromRGB(143, 255, 0 )
    B.TextSize = 14.000
    ...
    function K:Button(L, N)
        ...
        O.Name = "ButtonObj"
        O.Parent = E
        O.BackgroundColor3 = Color3.fromRGB(14, 14, 14)
        O.BorderSizePixel = 0
